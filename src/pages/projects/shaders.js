...
export function loadShadersWeek3Part1(widthScale, heightScale) {
  // Create renderer.
  ...
  const camera = new THREE.PerspectiveCamera(
    75,
    (widthScale * window.innerWidth) / (heightScale * window.innerHeight)
  )
  ...
  window.addEventListener("resize", () => {
    const w = window.innerWidth * widthScale
    const h = window.innerHeight * heightScale
    camera.aspect = w / h
